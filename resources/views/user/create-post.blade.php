                            ...
                            <div class="bank-inner-details">
                                <div class="row">
                                    <form action="{{ route('user.posts.store') }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    <label>{{ __('messages.tags') }}<span
                                                            class="text-danger">*</span></label>
                                                    <select name="tag" class="Select form-control"
                                                        data-placeholder="{{ __('messages.select_tags') }}" multiple
                                                        data-multi-select>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <small
                                                        class="form-text text-muted">{{ __('messages.thumbnail_info') }}</small>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="editor" class="form-control" id="body" placeholder="{{ __('messages.enter_description') }}"
                                            name="body"></textarea>
                                    </div>
                                </div>
                                <div class=" blog-categories-btn pt-0">
                                    <div class="bank-details-btn ">
                                        <button type="submit"
                                            class="btn bank-cancel-btn me-2">{{ __('messages.add_post') }}</button>
                                    </div>
                                </div>
                                </form>
