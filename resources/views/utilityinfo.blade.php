        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-10 offset-1">
                    <h2 style="text-align: center">Utility Information</h2>
                    <br />
                    <details>
                        <summary>What is a Utility Innovation?</summary>
                        <p>Utility innovation involves developing and implementing new technologies and practices to
                            improve the efficiency, reliability, and sustainability of utility services like
                            electricity, water, gas, and telecommunications. The aim is to reduce costs, minimize
                            environmental impact, and meet the changing needs of consumers and communities through
                            initiatives like renewable energy adoption, smart grids, IoT devices, and data analytics.
                        </p>
                    </details>
                    <details>
                        <summary>Duration of Utility Innovation</summary>
                        <p>A utility innovation is protected 10 + 5 + 5 years from the date of filing subject to use.
                        </p>
                    </details>
                </div>
                <div class="box">
