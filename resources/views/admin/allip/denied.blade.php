                    ...
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title">Denied Entries</h3>
                                </div>
                                    ...
                                    @foreach ($allEntries as $entry)
                                        <tr id="entryRow{{ $entry->id }}">
                                            ...
                                            <td>
                                                ...
                                                <a> <span
                                                        class="badge badge-soft-danger badge-border">{{ $entry->is_complete }}</span></a>
                                            ...
                                            <td class="text-end">
                                                ...
                                                @else
                                                    <div class="alert alert-warning text-center" role="alert">
                                                        This entry was submitted more <br> than 2 weeks ago. Status cannot
                                                        be
                                                        updated.
                                                    </div>
                                                @endif
