...
$(document).on('click','.mail-important',function(){$(this).find('i.fa').toggleClass('fa-star').toggleClass('fa-star-o');});if($('.summernote').length>0){$('.summernote').summernote({height:300,minHeight:null,maxHeight:null,focus:false});}
...
'</div>'+
'</div>';$(".links-info-discount").append(experiencecontent);return false;});$(".seller-next-btn").on('click',function(){$(this).closest('.tab-pane').next().css("display","block").css("opacity","1");$(this).closest('.tab-pane').css({'display':'none'});$('#basic-pills-wizard .nav-item.active').removeClass('active').addClass('activated').next().addClass('active');});$(".seller-previous-btn").on('click',function(){$(this).closest('.tab-pane').prev().css("display","block");$(this).closest('.tab-pane').css({'display':'none'});$('#basic-pills-wizard .nav-item.active').removeClass('active').prev().removeClass('activated').addClass('active');});if($('#summernote').length>0){$('#summernote').summernote({height:300,minHeight:null,maxHeight:null,focus:true});}
