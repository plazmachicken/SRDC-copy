...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <form method="POST" action="{{ route('saveItemUtil.update', ['formType' => $entry->formType, 'id' => $entry->id]) }}" accept-charset="UTF-8" class="patentForm"
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label>
                    <input type="radio" name="innovator_status" value="innovator" @checked($entry->innovator_status == 'innovator')> Yes
                </label>
                <label>
                    <input type="radio" name="innovator_status" value="not_innovator" @checked($entry->innovator_status == 'not_innovator')> No
                </label>
                <div id="innovator_info" style="display: none;">
                    <h3>If the applicant is not the innovator:</h3>
                    <label>Name of innovator: <input type="text" name="innovator_name" value="{{ is_null($entry->innovator_name) ? : $entry->innovator_name }}"></label><br>
                    <label>Address of innovator: <input type="text" name="innovator_address" value="{{ is_null($entry->innovator_address) ? '' : $entry->innovator_address }}"></label><br>
                </div>
            </div>
        </fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <label class="radio-inline" for="divisional-0">
                        <input type="radio" name="divisional" id="divisional-0" value="Yes" @checked($entry->divisional == 'Yes')>
                        Yes
                    </label>
                    <label class="radio-inline" for="divisional-1">
                        <input type="radio" name="divisional" id="divisional-1" value="No" @checked($entry->divisional == 'No')>
                        No
                    </label>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <label class="radio-inline" for="patentsymbol-0">
                        <input type="radio" name="patentsymbol" id="patentsymbol-0" value="Yes" @checked($entry->patentsymbol == 'Yes')>
                        Yes
                    </label>
